...
* Always use British spellings, correct all American spellings into British spellings
...
* At the start of each session read specs/tasks.md specs/requirements.md, specs/design.md and the specs/session_handover.md document
* When the plan changes, update the requirements.md, design.md and tasks.md documents
* When the context window or cache is getting full and tokens are running out and we need to start a new session, summarise the work done so far in specs/session_handover.md document
* There is a development log folder. For each session, please create a development log file with date and timestamp in the file name, listing all the work performed in this session. 
